...
const SignUpPage = () => {
  ...
  const validateForm = () => {
    ...
    if (!/^[a-zA-Z0-9._]{3,30}$/.test(formData.username))
      return toast.error("Username must be 3-30 characters (letters, numbers, dots, underscores)");
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div className="form-control w-full items-center">
              ...
              <label className="input input-bordered flex items-center gap-2 w-full max-w-md mx-auto">
                <User className="size-4 text-base-content/40 shrink-0" />
                <input
                  type="text"
                  className="grow"
            ...
            <div className="form-control w-full items-center">
              ...
              <label className="input input-bordered flex items-center gap-2 w-full max-w-md mx-auto">
                <AtSign className="size-4 text-base-content/40 shrink-0" />
                <input
                  type="text"
                  className="grow"
            ...
            <div className="form-control w-full items-center">
              ...
              <label className="input input-bordered flex items-center gap-2 w-full max-w-md mx-auto">
                <Lock className="size-4 text-base-content/40 shrink-0" />
                <input
